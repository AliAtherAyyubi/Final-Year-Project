...
import 'package:e_voting/Screens/Owner/Owner%20Elections/election.dart';
...
class _OwnerMainPageState extends State<OwnerMainPage> {
  ...
  void fetchUser() async {
    ...
    OrgModel? org = await OrgDatabase().fetchOrgById();
    print(user.userName);
    print(org!.orgName);
    setState(() {
          ...
          children: [
            ...
            Row(
              children: [
                ...
                Text(
                  'Welcome, $userName',
                  style: AppStyle().txt1.copyWith(color: Colors.grey.shade600),
                )
              ],
            ),
            SizedBox(
            ...
            GestureDetector(
              onTap: () => Get.to(() => OwnerElection(),
                  transition: Transition.rightToLeft),
              child: OwnerTiles(
                  fieldName: 'Create/Edit Elections', icon: Icons.how_to_vote),
            ),
            SizedBox(
              height: 5,
            ),
            OwnerTiles(fieldName: 'Create/Edit Candidates', icon: Icons.person),
          ],
        ),
      ),
    );
